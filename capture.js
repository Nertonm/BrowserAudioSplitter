*** Add File: capture.js
+// capture.js - captura via tabCapture (Chrome) e realiza split estéreo.
+// NOTE: NÃO chama getDisplayMedia automaticamente — isso evita bloqueios por falta de user gesture.
+// For fallback (Firefox), the popup will call getDisplayMedia (user gesture) and perform split there.
+(async function () {
